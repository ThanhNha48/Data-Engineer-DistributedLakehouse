    ...
    create table "iceberg"."gold_silver"."stg_products__dbt_tmp"
...
FROM "iceberg"."bronze"."olist_products_dataset" p
LEFT JOIN "iceberg"."bronze"."product_category_name_translation" t
